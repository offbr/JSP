 ...
 * Generated at: 2016-09-14 08:23:53 UTC
...
import mono.mybatis.ProcessDao;
...
public final class emailCheck_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("mono.mybatis.ProcessDao");
...
if(list.size() == 0){
      ...
      out.write("<a href =\"#\" onclick = \"opener.document.register.inputEmail.focus(); window.close();\">사용하기</a>\n");
	
}else{

      out.write("\n");
      out.write("이미 사용중인 이메일입니다.\n");
      out.write("<a href =\"#\" onclick = \"opener.document.register.inputEmail.value=''; window.close();\">재입력</a>\n");
