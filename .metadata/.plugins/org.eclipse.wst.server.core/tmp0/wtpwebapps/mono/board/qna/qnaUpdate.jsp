...
<!-- 글쓰기 -->
  <form action="qnaUpdateOk.jsp" method="post" name="qnaUpdateFrm">
  
<div class="container">
<div class="panel panel-default table-responsive">
	<input type="hidden" value="<%=b_no%>" name="b_no">
  	<input type="hidden" value="<%=dto.getB_name()%>" name="b_name">
  	<input type="hidden" value="<%=dto.getB_email()%>" name="b_email">
  	<input type="hidden" value="<%=dto.getB_tel()%>" name="b_tel">
  	
  <!-- Table -->
 	<table class="table" border="1">
  		<tr>
    		<th style="width: 100px">SUBJECT</th><td colspan="3"><input type="text" style="width: 100%;" name="b_title" value="<%=dto.getB_title()%>"></td>
   		</tr>
   		<tr>
   			<th>NAME</th><td colspan="3"><%=dto.getB_name()%></td>
   		</tr>
   		<tr>
   		...
   		<tr>
   			<th>CONTENT</th>
   			<td colspan="4"><textarea rows="10" style="width: 100%;" name="b_content"><%=dto.getB_content()%></textarea></td>
   		</tr>
   		<tr>
   			<th>Password</th>
