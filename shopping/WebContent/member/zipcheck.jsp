...
<%@page import="shop.member.ZiptapBean"%>
...
ArrayList<ZiptapBean> list = memberMgr.zipcodeRead(p_area3);
...
<body>
<b style="text-align: center;">** 우편번호 검색 **</b>
...
%>
		<table >
			<tr>
				<td style="text-align: center; color: lime; text-decoration: underline;">
...
<%
				for(int i = 0; i < list.size(); i++){
					...
					if(area4 == null) area4 = "";
%>
					<a href="javascript:send('<%=zipcode %>','<%=area1 %>','<%=area2 %>','<%=area3 %>','<%=area4 %>')" style="color: lime;">
